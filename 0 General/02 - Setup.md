...
2. [Install the latest version of Python](#install-the-latest-version-of-python)
3. [Install Git and make a GitHub account](#install-git-and-make-a-github-account)
